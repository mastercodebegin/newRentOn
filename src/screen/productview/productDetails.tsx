...
export default ProductDetails = (props) => {
  ...
  useEffect(() => {
    ...
    getVariants(0)
    // console.log('props fun---',getVariants(props.route.params.data))
  }, [])
  useEffect(() => {
  ...
  return (
    <ScrollView style={{ backgroundColor: COLORS.white, }}>
      ...
      <View style={{
        ...
        justifyContent: 'space-between', bottom: scaledSize(-10)
      }}>
        <TouchableOpacity
          // disabled={this.state.addedItem}
          style={[styles.viewBtn, COLORS.grey]}
          testID="btnSubmit">
        ...
        >
          <Text style={styles.viewBtnText}>Buy Now</Text>
        </TouchableOpacity>
      </View>
